...
usage() {
  cat <<'EOF'
Block force pushes to branches with open GitHub pull requests.
Usage: block-force-push.sh [--help]
Reads a hook JSON payload from stdin. No flags are required.
  -h, --help  Show this help and exit.
Example: block-force-push.sh < hook-event.json
EOF
}
